...
var spr_sab_reg = preload("res://Ressources/Survivor/Texture/Items/Weapons/laserSaber.png")
var spr_sab_atk = preload("res://Ressources/Survivor/Texture/Items/Weapons/laserSaber_attack.png")
...
func update_laserSaber():
	level = player.laserSaber_level
	match level:
		1:
			hp = 9999
			speed = 200.0
			...
			attack_speed = 5.0 * (1-player.attack_cooldown)
		2:
			hp = 9999
			speed = 200.0
			damage = 10
...
func enable_attack(atk = true):
	if atk:
		...
		sprite.texture = spr_sab_atk
	else:
		collision.call_deferred("set","disabled",true)
		sprite.texture = spr_sab_reg
